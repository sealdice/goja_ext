/*
 * Adapted from bare-stream (https://github.com/holepunchto/bare-stream)
 * Copyright Holepunch. Apache-2.0.
 *
 * Adaptations:
 *   - drop require('./web') (second WHATWG implementation)
 *   - Readable/Writable/Duplex fromWeb/toWeb delegate to ./bridge which uses
 *     the canonical web-streams-polyfill (injected by the Go layer)
 */
